...
//    }
//
//    public String buildEmailForRegistration(String token) {
...
//                "      <p style=\"margin:0 0 20px 0; font-size:19px; line-height:25px; color:#0b0c0c\">Welcome to Perry Library Management System!! We're thrilled to have you onboard.</p>\n" +
//                "      <p style=\"margin:0 0 20px 0; font-size:19px; line-height:25px; color:#0b0c0c\">\n" +
//                "        To ensure the security of your account and complete the registration process, please verify your email address by entering the OTP (One-Time Password) provided below:\n" +
//                "      </p>\n" +
